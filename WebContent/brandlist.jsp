...
<head>
  ...
  <style>
  	#brandDataTable th { text-align: center }
  	#brandDataTable td { text-align: center }
  </style>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">品牌清单</h1>
          
          <div class="row mb-4">
            <div class="col col-sm-12 col-md-2">
              <a href="brandadd.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="col col-sm-12 col-md-1">
              <a href="itemlist.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-right: auto;">
          ...
          <div class="card shadow bg-border-dark-with-same-bg mb-4">
            <div class="card-header bg-header-dark py-3">
              <h6 class="m-0 font-weight-bold">所有项目</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="brandDataTable">
                  <thead>
	                <tr>
	                	<th>编号</th>
	                    <th>品牌</th>
				  ...
				  %>
				  	<tr>
				  		...
				  		<td><img class="img-profile" style="max-height: 40px; max-width: 40px" 
												src="resources/images/brands/<%= brand.getPic() %>"></td>
				  		<td><%= brand.getType() == 1 ? "普通" : "首页展示" %></td>
				  	</tr>
				  <% } %>
				  </tbody>
                </table>
