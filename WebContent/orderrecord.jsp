...
<head>
  ...
  <style>
  	#orderRecordDataTable th { text-align: center }
  	#orderRecordDataTable td { text-align: center }
  </style>
</head>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow bg-border-dark-with-same-bg mb-4">
            <div class="card-header bg-header-dark py-3">
              <h6 class="m-0 font-weight-bold">订单记录</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="orderRecordDataTable">
                  <thead>
                    <tr>
                      <th>Order Num</th>
                      <th>Submit Date</th>
                      <th>User Name</th>
                      <th>Sum of Address</th>
                      <th>Payment Way</th>
                      <th>Order record</th>
                      <th>Operation</th>
                    </tr>
                  ...
                  %>
                    ...
                    <tr>
                      ...
                      <td><%= user.getBuyCount() %></td>  
                      <td><%= user.getDealCount() %></td> 
...
<script>
	$(function() {
		$('#orderRecordDataTable').DataTable({
